...
def calculate_perplexity(text):
    ...
    perplexity = torch.exp(torch.nn.functional.cross_entropy(logits.view(-1, logits.size(-1)), input_ids.view(-1))) #torch.nn.functional.
    ...
    if st.button("Analyze"):
        ...
        with col2:
            ...
            if perplexity > max_perplexity:
                ...
                st.write("Percentage of being generated by AI: 100%")
                st.error("Text Analysis Result: Highly likely AI generated content")
            else:
                ai_percentage = ((perplexity - min_perplexity) / (max_perplexity - min_perplexity)) * (
                            (max_burstiness - burstiness_score) / (max_burstiness - min_burstiness)) * 100
